const App = () => {
  return (
    <div className="notification notification-wrapper">
      <header className="notification__header">
        <div className="notification__heading-wrapper">
          <h1 className="notification__heading">Notifications</h1>
          <p className="notification__count">3</p>
        </div>
        <p className="notification__toggle">Mark all as read</p>
      </header>
        ...
        <ul className="notification__list">
            ...
            <div className="item__content">
              <div className="item__notification-wrapper">
                <p className="item__notification">
                  <span className="item__name">Mark Webber</span> reacted to
                  your recent post{' '}
          ...
          <li className="notification__item">
            ...
            <div className="item__content">
              <div className="item__notification-wrapper">
                <p className="item__notification">
                  <span className="item__name">Rizky Hasanuddin</span> sent you
                  a private message
                </p>
          ...
          <li className="notification__item">
            ...
            <div className="item__content">
              <div className="item__notification-wrapper">
                <p className="item__notification">
                  <span className="item__name">Kimberly Smith</span> commented
                  on your picture
                </p>
